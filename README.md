...
prek5th = 49
# bundle comes with 
totalprek5th = costPrek5th*prek5th

cost6th8th = 1179
sixth8th = 162
total6th8th = cost6th8th*sixth8th

discount = (totalprek5th+total6th8th)*.1

totalSS = totalprek5th+total6th8th - discount
...
focusGroupTotal = focusGroups+contentAnalysis+pizza+trans

yearOneTwo = focusGroupTotal+overSight+fidelity 
...
fidelityYear2 = teachersYears2*cost*times

yearOneTwoEval = yearOneTwo + fidelity 

teachersYears34 = 106

fidelityYears34 = teachersYears34*cost*times

yearThreeFourEval = confSurvey+dataEntry+focusGroupTotal+dataAnalysis+overSight+finalReports++fidelityYears34
```
...
bs = 2
bsSalary = 33862
genEd = 715-(round(715/14))
genEdSalary = 46192 
perctOther = .05
perctGenEd = .025
allStaff = round((sc*scSalary+sw*swSalary+sc*scSalary+bs*bsSalary)*perctOther)+(genEd*genEdSalary*perctGenEd)
eachYear = round(allStaff/3)
...
yearThreeHours = 6930
yearFourHours = 1890
centerstoneAndROI = 2 + 2

centerstone = 27000*1.4
roi = 30000*1.4
total = centerstone*2 + roi*2
```
Two centerstone people and two 
